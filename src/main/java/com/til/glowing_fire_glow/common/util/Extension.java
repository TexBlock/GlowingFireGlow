...
public class Extension {
    ...
    public static class VariableData_2<D1, D2> implements Map.Entry<D1, D2> {
        ...
        public static class ItemInPack extends VariableData_2<Tag<Item>, Integer> {

            public ItemInPack(Tag<Item> k, int v) {
                super(k, v);
            }
        }

        public static class FluidInPack extends VariableData_2<Tag<Fluid>, Integer> {

            public FluidInPack(Tag<Fluid> k, int v) {
                super(k, v);
            }
        }
    }
